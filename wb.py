...
filename = os.path.join(current_dir, r"C:\Users\SHRIYA JOSHI\OneDrive\Documents\Book1.xlsx")

# Load workbook
Book1 = openpyxl.load_workbook(filename)


sheet = Book1['contacts']

anothersheet = Book1.active
...
print(tuple(sheet['A1':'E3']))

for rowOfCellObjects in sheet['A1':'E3']:
